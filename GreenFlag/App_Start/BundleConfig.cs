    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/plugin").Include(
                "~/Theme/OnePage/js-plugin/respond/respond.src.js"
                ...
                , "~/Theme/OnePage/js-plugin/flexslider/jquery.flexslider.js"
                , "~/Theme/OnePage/js-plugin/isotope/jquery.isotope.js"
                , "~/Theme/OnePage/js-plugin/neko-contact-ajax-plugin/js/jquery.form.js"
                , "~/Theme/OnePage/js-plugin/neko-contact-ajax-plugin/js/jquery.validate.js"
                , "~/Theme/OnePage/js-plugin/magnific-popup/jquery.magnific-popup.js"
                , "~/Theme/OnePage/js-plugin/parallax/js/js-plugin/parallax/js/jquery.scrollTo-1.4.3.1-min.js"
                , "~/Theme/OnePage/js-plugin/parallax/js/jquery.localscroll-1.2.7-min.js"
                , "~/Theme/OnePage/js-plugin/parallax/js/jquery.stellar.js"
                , "~/Theme/OnePage/js-plugin/appear/jquery.appear.js"
                , "~/Theme/OnePage/js-plugin/pageSlide/jquery.pageslide-custom.js"
                , "~/Theme/OnePage/js-plugin/jquery.sharrre-1.3.4/jquery.sharrre-1.3.4.js"
                , "~/Theme/OnePage/js-plugin/owl.carousel/owl-carousel/owl.carousel.js"
